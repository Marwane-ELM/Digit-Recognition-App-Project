...
1. Vous importez des images de chiffre dans le dossier `data/Images/`. **Quelques images** se trouvent dans le dossier si vous voulez **tester brièvement** l'interface.
