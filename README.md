...
3. [Arborescence de fichiers](#arborescence)
...
Vous pouvez trouver le fichier notebook `theorie_mathematique.ipynb` contenant la **théorie mathématique** et **le code from scratch** du classifieur de Bayes (continues ou discrètes), que j'ai codé, situé dans `notebooks/theorie_mathematique/`
